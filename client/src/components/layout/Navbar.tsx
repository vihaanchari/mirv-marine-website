...
export function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 w-full bg-gradient-to-b from-white via-white/95 to-background/20 backdrop-blur-sm border-b border-secondary/10 shadow-sm transition-all duration-300">
