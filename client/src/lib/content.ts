import { LucideIcon, Anchor, Ship, GraduationCap, Laptop, Users, Award, Shield, Monitor } from "lucide-react";

// Asset Paths
export const ASSETS = {
  logo: "/attached_assets/logo-removebg-preview_1766125964455.png",
  slideshow: [
    "/attached_assets/Screenshot_2025-12-18_140054_1766130651823.png", // Ship
    "/attached_assets/Screenshot_2025-12-18_140134_1766130651824.png", // Deck
    "/attached_assets/WhatsApp_Image_2025-12-19_at_13.17.06_(2)_1766130651826.jpeg", // Sea
    "/attached_assets/WhatsApp_Image_2025-12-19_at_13.17.04_1766130651825.jpeg", // Training
    "/attached_assets/WhatsApp_Image_2025-12-19_at_13.17.02_(1)_1766130651824.jpeg" // Office
  ]
};
...
export const CONTENT = {
  ...
  about: {
    ...
    mission: "To provide maritime training, keeping in pace with the fast-changing world of shipping, to deliver competent and proficient seafarers who shall excel in the shipping industry.",
    vision: "Our vision is to be recognized as a global supplier of the highest quality of maritime services and training to the shipping industry."
  },
  services: [
    {
      title: "Maritime Training",
      icon: GraduationCap,
      description: "Online & Offline Courses with Simulator (Cloud-based). LCHS, ERM, BRM, AHTS, JRM + Sire 2.0 training needs.",
      details: ["MiRV Marine Academy - ABS Certified", "Online Cloud Simulator", "SIRE 2.0 Deliverables"]
    },
    {
      title: "Audits & Inspections",
      icon: Shield,
      description: "3rd Party Audits, VDR Analysis, Remote Navigation Audits (RNA), Pre-Purchase/Pre-Vetting Inspections.",
      details: ["Over 200 Vessels Completed", "Remote Navigation Audits", "Incident/Accident Analysis"]
    },
    {
      title: "Software & LMS",
      icon: Laptop,
      description: "Marine Digitalisation. Demo APPS for SIRE 2.0, Job Portal App, Competency Management Systems.",
      details: ["SIREfit APP", "Career Progression Systems", "LMS Creation"]
    },
    {
      title: "Manning & Crewing",
      icon: Users,
      description: "Manning for RSV, Off-shore & Coastal vessels. Coaching & Mentoring Ashore/Onboard.",
      details: ["More than 2500 crew trained", "Live Dashboard for Performance", "OJT Mentoring"]
    }
  ],
  team: [
    {
