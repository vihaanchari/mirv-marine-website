  ...
  return (
    <div className="min-h-screen flex flex-col bg-background font-sans">
      ...
      <main className="flex-grow">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-8 order-2 lg:order-1">
                <div className="space-y-4">
                  <h2 className="text-sm font-bold tracking-widest text-secondary uppercase">Our Story</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
                  <div className="bg-white p-6 rounded-lg shadow-sm border-l-4 border-primary">
                    ...
                    <p className="text-sm text-muted-foreground">{CONTENT.about.mission}</p>
                  </div>
                  <div className="bg-white p-6 rounded-lg shadow-sm border-l-4 border-secondary">
                    ...
                    <p className="text-sm text-muted-foreground">{CONTENT.about.vision}</p>
                  </div>
                </div>
              </div>
        ...
        {/* Services Section */}
        <section id="services" className="py-20 bg-slate-50 border-y border-border">
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
              <h2 className="text-sm font-bold tracking-widest text-primary uppercase">What We Do</h2>
              <h3 className="text-4xl md:text-5xl font-serif font-bold text-primary">Services & Products</h3>
              <p className="text-muted-foreground text-lg">Comprehensive maritime solutions tailored for the modern shipping industry.</p>
        ...
        <section id="team" className="py-20 relative bg-primary text-white">
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
              <h2 className="text-sm font-bold tracking-widest text-secondary uppercase">Leadership</h2>
              <h3 className="text-4xl md:text-5xl font-serif font-bold text-white">Our Team</h3>
              <div className="w-16 h-1 bg-secondary rounded-full mx-auto"></div>
            </div>
                ...
                <div key={index} className="bg-white/5 backdrop-blur-sm border border-white/10 p-8 rounded-lg hover:bg-white/10 transition-colors">
                  <div className="flex flex-col md:flex-row gap-6 items-start">
                    <div className="flex-1 space-y-3">
                      <div>
                        <h4 className="text-2xl font-serif font-bold text-secondary">{member.name}</h4>
                        <p className="text-sm uppercase tracking-wider text-white/70 font-medium">{member.role}</p>
                      </div>
        ...
        <section className="py-20 bg-background text-center">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto space-y-8">
              <h2 className="text-3xl md:text-4xl font-serif font-bold text-primary">Ready to elevate your maritime operations?</h2>
              <p className="text-xl text-muted-foreground">
                Join hundreds of satisfied clients who trust MiRV MARiNE for their training and inspection needs.
              </p>
              <div className="flex justify-center gap-4">
                 <Button size="lg" className="bg-primary hover:bg-primary/90 text-white font-bold px-10 py-6 text-lg shadow-lg">
                  Contact Us Today
                </Button>
              </div>
            </div>
